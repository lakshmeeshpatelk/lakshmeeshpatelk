...
🤖I’m a recent grad and a  full stack developer working primarily with JavaScript and Python.  
I build web applications end to end, using React for the frontend and Node.js for backend services, with experience designing and working with both SQL and MongoDB databases.

I’m comfortable with my current stack and continue to improve it by shipping real projects, making better architectural decisions, and refining code quality through iteration.
